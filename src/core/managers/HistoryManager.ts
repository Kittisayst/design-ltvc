...
export class HistoryManager {
     ...
     */
    saveState(label: string | null = null): void {
     ...
     */
    getFullState(index: number): Record<string, unknown> | null {
    ...
    private async loadState(stateObj: Record<string, unknown>): Promise<void> {
        this.locked = true;
        try {
